...
class tds_compass_module_style02 extends td_style {
	...
	private function get_css() {
		...
		$raw_css =
			"<style>
				...
				.$unique_block_class .td-compass-image-wrap-style {
                    position: relative;
                }
                .$unique_block_class .td-compass-meta-info-table {
                    position: absolute;
                    top: 0;
                    width: 100%;
                    height: 100%;
                ...
                .$unique_block_class .td-compass-average-score {
                    display: inline-block;
                }
                .$unique_block_class .td-compass-review-score {
                    display: inline-block;
                }
                .$unique_block_class .td-compass-review-score {
                    min-width: 77.7px;
                ...
                @media (max-width:765px) {
                    .tds_compass_module_style02 .td-next-prev-wrap {
                ...
                @media (max-width:765px) {
                    .tds_compass_module_style02 .td-ajax-next-page{
                        position: relative;
                        right: 0;
                        margin-right: 0;
                    }
                ...
                @media (max-width:765px) {
                    .tds_compass_module_style02 .td-ajax-prev-page{
                        margin-left: 0;
                    }
                }
                .$unique_block_class .tds_compass_module02 {
                padding-bottom: 0;
                }
                
                /* @f_art_title_compass */
                .$unique_block_class .td-compass-title-header .td-module-title {
                    @f_art_title_compass;
                }
                /* @f_average_score_label_compass */
                .$unique_block_class .td-compass-average-score-label {
                    @f_average_score_label_compass;
                }
                /* @f_review_score_label_compass */
                .$unique_block_class .td-compass-review-score-label {
                    @f_review_score_label_compass;
                }
                /* @f_average_score_compass */
                .$unique_block_class .td-compass-average-score {
                    @f_average_score_compass;
                }
                /* @f_review_score_compass */
                .$unique_block_class .td-compass-review-score {
                    @f_review_score_compass;
                }
                
                /* @td_compass_title_color */
				.$unique_block_class .td-compass-image-wrap-style .td-compass-title-header .td-module-title a{
					color: @td_compass_title_color;
				}
				/* @td_compass_average_score_label_color */
				.$unique_block_class .td-compass-average-score-label {
					color: @td_compass_average_score_label_color;
				}
				/* @td_compass_review_score_label_color */
				.$unique_block_class .td-compass-review-score-label {
					color: @td_compass_review_score_label_color;
				}
				/* @td_compass_average_score_color */
				.$unique_block_class .td-compass-average-score {
					color: @td_compass_average_score_color;
				}
				/* @td_compass_review_score_color */
				.$unique_block_class .td-compass-review-score {
					color: @td_compass_review_score_color;
				}
				/* @td_compass_average_score_background_color */
				.$unique_block_class .td-compass-meta-info-table .td-compass-average-score {
					background-color: @td_compass_average_score_background_color;
				}
				/* @td_compass_review_score_background_color */
				.$unique_block_class .td-compass-meta-info-table .td-compass-review-score {
					background-color: @td_compass_review_score_background_color;
				}
				
				/* @td_compass_average_score_background_color_hover */
				.$unique_block_class .td-compass-meta-info-table:hover .td-compass-average-score {
					background-color: @td_compass_average_score_background_color_hover;
				}
				/* @td_compass_review_score_background_color_hover */
				.$unique_block_class .td-compass-meta-info-table:hover .td-compass-review-score {
					background-color: @td_compass_review_score_background_color_hover;
				}
				
				/* @td_compass_image_border_color */
				.$unique_block_class .td-compass-image-wrap-style {
					border-color: @td_compass_image_border_color;
				}
				
				/* @td_compass_average_score_margin */
				.$unique_block_class .td-compass-average-score {
				margin: @td_compass_average_score_margin;
				}
				
				/* @td_compass_title_margin */
				.$unique_block_class .td-compass-title-header {
				margin: @td_compass_title_margin;
				}
				
				/* @td_compass_review_score_margin */
				.$unique_block_class .td-compass-review-score {
				margin: @td_compass_review_score_margin;
				}
				
				/* @td_compass_average_score_padding */
				.$unique_block_class .td-compass-average-score {
					padding: @td_compass_average_score_padding;
				}
				
				/* @td_compass_review_score_padding */
				.$unique_block_class .td-compass-review-score {
					padding: @td_compass_review_score_padding;
				}
				
				/* @td_compass_average_score_border_radius */
				.$unique_block_class .td-compass-average-score {
					border-radius: @td_compass_average_score_border_radius;
				}
				/* @td_compass_review_score_border_radius */
				.$unique_block_class .td-compass-review-score {
					border-radius: @td_compass_review_score_border_radius;
				}
				/* @td_compass_image_container_border */
				.$unique_block_class .tds_compass_module02 .td-compass-image-wrap-style {
					border-width: @td_compass_image_container_border;
				}
				
				.$unique_block_class .tds_compass_module02 .td-compass-image-wrap-style {
				    border-style: @td_compass_image_container_border_style;
				}
				
				.$unique_block_class .tds_compass_module02 .td-compass-image-wrap-style {
				    border-radius: @td_compass_image_container_border_radius;
				}
...
//        $res_ctx->load_settings_raw( 'modules_border_color', $res_ctx->get_style_att('modules_border_color', __CLASS__) );
        ...
        // *- fonts -* //
        $res_ctx->load_font_settings( 'f_art_title_compass', __CLASS__ );
        $res_ctx->load_font_settings( 'f_average_score_label_compass', __CLASS__ );
        $res_ctx->load_font_settings( 'f_review_score_label_compass', __CLASS__ );
        $res_ctx->load_font_settings( 'f_average_score_compass', __CLASS__ );
        $res_ctx->load_font_settings( 'f_review_score_compass', __CLASS__ );

        //colors
        $res_ctx->load_settings_raw( 'td_compass_title_color', $res_ctx->get_style_att('td_compass_title_color', __CLASS__) );
        $res_ctx->load_settings_raw( 'td_compass_average_score_label_color', $res_ctx->get_style_att('td_compass_average_score_label_color', __CLASS__) );
        $res_ctx->load_settings_raw( 'td_compass_review_score_label_color', $res_ctx->get_style_att('td_compass_review_score_label_color', __CLASS__) );
        $res_ctx->load_settings_raw( 'td_compass_average_score_color', $res_ctx->get_style_att('td_compass_average_score_color', __CLASS__) );
        $res_ctx->load_settings_raw( 'td_compass_review_score_color', $res_ctx->get_style_att('td_compass_review_score_color', __CLASS__) );
        $res_ctx->load_settings_raw( 'td_compass_average_score_background_color', $res_ctx->get_style_att('td_compass_average_score_background_color', __CLASS__) );
        $res_ctx->load_settings_raw( 'td_compass_review_score_background_color', $res_ctx->get_style_att('td_compass_review_score_background_color', __CLASS__) );
        $res_ctx->load_settings_raw( 'td_compass_average_score_background_color_hover', $res_ctx->get_style_att('td_compass_average_score_background_color_hover', __CLASS__) );
        $res_ctx->load_settings_raw( 'td_compass_review_score_background_color_hover', $res_ctx->get_style_att('td_compass_review_score_background_color_hover', __CLASS__) );
        $res_ctx->load_settings_raw( 'td_compass_image_border_color', $res_ctx->get_style_att('td_compass_image_border_color', __CLASS__) );

        // average score margin
        $td_compass_average_score_margin = $res_ctx->get_style_att('td_compass_average_score_margin', __CLASS__);
        $res_ctx->load_settings_raw( 'td_compass_average_score_margin', $td_compass_average_score_margin );
        if ( is_numeric( $td_compass_average_score_margin ) ) {
            $res_ctx->load_settings_raw( 'td_compass_average_score_margin', $td_compass_average_score_margin . 'px' );
        }

        // title margin
        $td_compass_title_margin = $res_ctx->get_style_att('td_compass_title_margin', __CLASS__);
        $res_ctx->load_settings_raw( 'td_compass_title_margin', $td_compass_title_margin );
        if ( is_numeric( $td_compass_title_margin ) ) {
            $res_ctx->load_settings_raw( 'td_compass_title_margin', $td_compass_title_margin . 'px' );
        }

        // review score margin
        $td_compass_review_score_margin = $res_ctx->get_style_att('td_compass_review_score_margin', __CLASS__);
        $res_ctx->load_settings_raw( 'td_compass_review_score_margin', $td_compass_review_score_margin );
        if ( is_numeric( $td_compass_review_score_margin ) ) {
            $res_ctx->load_settings_raw( 'td_compass_review_score_margin', $td_compass_review_score_margin . 'px' );
        }

        // average score padding
        $td_compass_average_score_padding = $res_ctx->get_style_att('td_compass_average_score_padding', __CLASS__);
        $res_ctx->load_settings_raw( 'td_compass_average_score_padding', $td_compass_average_score_padding );
        if( $td_compass_average_score_padding != '' && is_numeric( $td_compass_average_score_padding ) ) {
            $res_ctx->load_settings_raw( 'td_compass_average_score_padding', $td_compass_average_score_padding . 'px' );
        }

        // review score padding
        $td_compass_review_score_padding = $res_ctx->get_style_att('td_compass_review_score_padding', __CLASS__);
        $res_ctx->load_settings_raw( 'td_compass_review_score_padding', $td_compass_review_score_padding );
        if( $td_compass_review_score_padding != '' && is_numeric( $td_compass_review_score_padding ) ) {
            $res_ctx->load_settings_raw( 'td_compass_review_score_padding', $td_compass_review_score_padding . 'px' );
        }

        // average score border radius
        $td_compass_average_score_border_radius = $res_ctx->get_style_att('td_compass_average_score_border_radius', __CLASS__);
        $res_ctx->load_settings_raw( 'td_compass_average_score_border_radius', $td_compass_average_score_border_radius );
        if ( is_numeric( $td_compass_average_score_border_radius ) ) {
            $res_ctx->load_settings_raw( 'td_compass_average_score_border_radius', $td_compass_average_score_border_radius . 'px' );
        }
        // review score border radius
        $td_compass_review_score_border_radius = $res_ctx->get_style_att('td_compass_review_score_border_radius', __CLASS__);
        $res_ctx->load_settings_raw( 'td_compass_review_score_border_radius', $td_compass_review_score_border_radius );
        if ( is_numeric( $td_compass_review_score_border_radius ) ) {
            $res_ctx->load_settings_raw( 'td_compass_review_score_border_radius', $td_compass_review_score_border_radius . 'px' );
        }

        // image border width
        $td_compass_image_container_border = $res_ctx->get_style_att('td_compass_image_container_border', __CLASS__);
        $res_ctx->load_settings_raw( 'td_compass_image_container_border', $td_compass_image_container_border );
        if ( is_numeric( $td_compass_image_container_border ) ) {
            $res_ctx->load_settings_raw( 'td_compass_image_container_border', $td_compass_image_container_border . 'px' );
        }

        // image border style
        $res_ctx->load_settings_raw( 'td_compass_image_container_border_style', $res_ctx->get_style_att('td_compass_image_container_border_style', __CLASS__) );
        // modules border radius
        $td_compass_image_container_border_radius = $res_ctx->get_style_att('td_compass_image_container_border_radius', __CLASS__);
        $res_ctx->load_settings_raw( 'td_compass_image_container_border_radius', $td_compass_image_container_border_radius );
        if ( is_numeric( $td_compass_image_container_border_radius ) ) {
            $res_ctx->load_settings_raw( 'td_compass_image_container_border_radius', $td_compass_image_container_border_radius . 'px' );
        }
