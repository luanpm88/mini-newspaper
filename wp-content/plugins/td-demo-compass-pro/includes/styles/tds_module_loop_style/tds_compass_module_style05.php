...
class tds_compass_module_style05 extends td_style {
	...
	private function get_css() {
		...
		$raw_css =
			"<style>
				...
				.$unique_block_class .td-compass-image-wrap-5style {
                    position: relative;
                }
                .$unique_block_class .td-compass-meta-info-5table {
                    position: absolute;
                    top: 0;
                    width: 100%;
                    height: 100%;
                ...
                .$unique_block_class .td-compass-image-wrap-5style .td-module-thumb .entry-thumb {
                    clip-path: polygon(100% 0, 0% 100%, 100% 100%);
                }
                .$unique_block_class .td-compass-review-score-5container {
                    display: flex;
                    justify-content: center;
                }
                .$unique_block_class .td-compass-label-5container {
                    display: flex;
                    justify-content: center;
                }
                .$unique_block_class .td-compass-release-date-5container {
                    display: flex;
                    justify-content: center;
                }
                .$unique_block_class .td-compass-review-score-5name {
                    margin-left: 5px;
                }
                .$unique_block_class .td-compass-label-5name {
                    margin-left: 5px;
                }
                .$unique_block_class .td-compass-release-date-5name {
                    margin-left: 5px;
                }
                .$unique_block_class .td-compass-image-wrap-5style .td-module-thumb {
                    filter: drop-shadow(0 0 45px rgba(13,163,172,0.5));
                }
				/* @image_width */
				.$unique_block_class .td-image-wrap {
                ...
                @media (max-width:765px) {
                    .tds_compass_module_style05 .td-next-prev-wrap {
                ...
                @media (max-width:765px) {
                    .tds_compass_module_style05 .td-ajax-next-page{
                        position: relative;
                        right: 0;
                        margin-right: 0;
                    }
                ...
                @media (max-width:765px) {
                    .tds_compass_module_style05 .td-ajax-prev-page{
                        margin-left: 0;
                    }
                }
                .$unique_block_class .tds_compass_module05 {
                padding-bottom: 0;
                }
				...
				/* @f_art_title_5compass */
                .$unique_block_class .td-compass-title-5header a {
                    @f_art_title_5compass;
                }
                /* @f_release_5date_compass */
                .$unique_block_class .td-compass-release-5date {
                    @f_release_5date_compass;
                }
                /* @f_release_5date_info_compass */
                .$unique_block_class .td-compass-release-date-5name {
                    @f_release_5date_info_compass;
                }
                /* @f_label_5compass */
                .$unique_block_class .td-compass-5label {
                    @f_label_5compass;
                }
                /* @f_label_5compass_name */
                .$unique_block_class .td-compass-label-5name {
                    @f_label_5compass_name;
                }
                /* @f_review_5score_compass */
                .$unique_block_class .td-compass-review-5score {
                    @f_review_5score_compass;
                }
                /* @f_review_5score_compass_info */
                .$unique_block_class .td-compass-review-score-5name {
                    @f_review_5score_compass_info;
                }
                /* @f_buy_5album_compass */
                .$unique_block_class .td-compass-button-5link {
                    @f_buy_5album_compass;
                }
                
                /* margins and paddings */
                /* @td_compass_title5_margins */
                .$unique_block_class .td-compass-title-5header {
                    margin: @td_compass_title5_margins;
                }
                /* @td_compass_release5_margins */
                .$unique_block_class .td-compass-release-date-5container {
                    margin: @td_compass_release5_margins;
                }
                /* @td_compass_label5_margins */
                .$unique_block_class .td-compass-label-5container {
                    margin: @td_compass_label5_margins;
                }
                /* @td_compass_review5_margins */
                .$unique_block_class .td-compass-review-score-5container {
                    margin: @td_compass_review5_margins;
                }
                /* @td_compass_buyalbum5_margins */
                .$unique_block_class .td-compass-buy-5album {
                    margin: @td_compass_buyalbum5_margins;
                }
                
                /* colors */
                /* @td_compass_title5_co */
                .$unique_block_class .td-compass-title-5header a {
                    color: @td_compass_title5_co;
                }
                /* @td_compass_title5_coho */
                .$unique_block_class .td-compass-title-5header a:hover {
                    color: @td_compass_title5_coho;
                }
                /* @td_compass_buyalbum5_co */
                .$unique_block_class .td-compass-buy-5album a {
                    color: @td_compass_buyalbum5_co;
                }
                /* @td_compass_buyalbum5_coho */
                .$unique_block_class .td-compass-buy-5album:hover a {
                    color: @td_compass_buyalbum5_coho;
                }
                /* @td_compass_releasedate5_co */
                .$unique_block_class .td-compass-release-5date {
                    color: @td_compass_releasedate5_co;
                }
                /* @td_compass_releasedatename5_co */
                .$unique_block_class .td-compass-release-date-5name {
                    color: @td_compass_releasedatename5_co;
                }
                /* @td_compass_label5_co */
                .$unique_block_class .td-compass-5label {
                    color: @td_compass_label5_co;
                }
                /* @td_compass_labelname5_co */
                .$unique_block_class .td-compass-label-5name {
                    color: @td_compass_labelname5_co;
                }
                /* @td_compass_reviewscore5_co */
                .$unique_block_class .td-compass-review-5score {
                    color: @td_compass_reviewscore5_co;
                }
                /* @td_compass_reviewscorename5_co */
                .$unique_block_class .td-compass-review-score-5name {
                    color: @td_compass_reviewscorename5_co;
                }
...
//        $res_ctx->load_settings_raw( 'modules_border_color', $res_ctx->get_style_att('modules_border_color', __CLASS__) );
        ...
        //fonts for compass 3
        $res_ctx->load_font_settings( 'f_art_title_5compass', __CLASS__ );
        $res_ctx->load_font_settings( 'f_release_5date_compass', __CLASS__ );
        $res_ctx->load_font_settings( 'f_release_5date_info_compass', __CLASS__ );
        $res_ctx->load_font_settings( 'f_label_5compass', __CLASS__ );
        $res_ctx->load_font_settings( 'f_label_5compass_name', __CLASS__ );
        $res_ctx->load_font_settings( 'f_review_5score_compass', __CLASS__ );
        $res_ctx->load_font_settings( 'f_review_5score_compass_info', __CLASS__ );
        $res_ctx->load_font_settings( 'f_buy_5album_compass', __CLASS__ );

        //margins and paddings
        // title margins
        $td_compass_title5_margins = $res_ctx->get_style_att('td_compass_title5_margins', __CLASS__);
        $res_ctx->load_settings_raw( 'td_compass_title5_margins', $td_compass_title5_margins );
        if( $td_compass_title5_margins != '' && is_numeric( $td_compass_title5_margins ) ) {
            $res_ctx->load_settings_raw( 'td_compass_title5_margins', $td_compass_title5_margins . 'px' );
        }
        // release date margins
        $td_compass_release5_margins = $res_ctx->get_style_att('td_compass_release5_margins', __CLASS__);
        $res_ctx->load_settings_raw( 'td_compass_release5_margins', $td_compass_release5_margins );
        if( $td_compass_release5_margins != '' && is_numeric( $td_compass_release5_margins ) ) {
            $res_ctx->load_settings_raw( 'td_compass_release5_margins', $td_compass_release5_margins . 'px' );
        }
        // label margins
        $td_compass_label5_margins = $res_ctx->get_style_att('td_compass_label5_margins', __CLASS__);
        $res_ctx->load_settings_raw( 'td_compass_label5_margins', $td_compass_label5_margins );
        if( $td_compass_label5_margins != '' && is_numeric( $td_compass_label5_margins ) ) {
            $res_ctx->load_settings_raw( 'td_compass_label5_margins', $td_compass_label5_margins . 'px' );
        }
        // review score margins
        $td_compass_review5_margins = $res_ctx->get_style_att('td_compass_review5_margins', __CLASS__);
        $res_ctx->load_settings_raw( 'td_compass_review5_margins', $td_compass_review5_margins );
        if( $td_compass_review5_margins != '' && is_numeric( $td_compass_review5_margins ) ) {
            $res_ctx->load_settings_raw( 'td_compass_review5_margins', $td_compass_review5_margins . 'px' );
        }
        // buy album margins
        $td_compass_buyalbum5_margins = $res_ctx->get_style_att('td_compass_buyalbum5_margins', __CLASS__);
        $res_ctx->load_settings_raw( 'td_compass_buyalbum5_margins', $td_compass_buyalbum5_margins );
        if( $td_compass_buyalbum5_margins != '' && is_numeric( $td_compass_buyalbum5_margins ) ) {
            $res_ctx->load_settings_raw( 'td_compass_buyalbum5_margins', $td_compass_buyalbum5_margins . 'px' );
        }

        //colors
        $res_ctx->load_settings_raw( 'td_compass_title5_co', $res_ctx->get_style_att('td_compass_title5_co', __CLASS__) );
        $res_ctx->load_settings_raw( 'td_compass_title5_coho', $res_ctx->get_style_att('td_compass_title5_coho', __CLASS__) );
        $res_ctx->load_settings_raw( 'td_compass_buyalbum5_co', $res_ctx->get_style_att('td_compass_buyalbum5_co', __CLASS__) );
        $res_ctx->load_settings_raw( 'td_compass_buyalbum5_coho', $res_ctx->get_style_att('td_compass_buyalbum5_coho', __CLASS__) );
        $res_ctx->load_settings_raw( 'td_compass_releasedate5_co', $res_ctx->get_style_att('td_compass_releasedate5_co', __CLASS__) );
        $res_ctx->load_settings_raw( 'td_compass_releasedatename5_co', $res_ctx->get_style_att('td_compass_releasedatename5_co', __CLASS__) );
        $res_ctx->load_settings_raw( 'td_compass_label5_co', $res_ctx->get_style_att('td_compass_label5_co', __CLASS__) );
        $res_ctx->load_settings_raw( 'td_compass_labelname5_co', $res_ctx->get_style_att('td_compass_labelname5_co', __CLASS__) );
        $res_ctx->load_settings_raw( 'td_compass_reviewscore5_co', $res_ctx->get_style_att('td_compass_reviewscore5_co', __CLASS__) );
        $res_ctx->load_settings_raw( 'td_compass_reviewscorename5_co', $res_ctx->get_style_att('td_compass_reviewscorename5_co', __CLASS__) );
