...
class tds_email_notifications {
    ...
    static function send_admin_email_notification( $notif_type, $user_id, $add_tags = array(), $add_tags_replacements = array() ) {
        ...
        if( $enabled_for_admins ) {
            ...
            $admin_activate_email_tds_option = tds_util::get_tds_option('activate_email_notif');

            $admin_from_email_tds_option = tds_util::get_tds_option('from_email');
            $from_email = !is_null( $admin_from_email_tds_option ) && !is_null($admin_activate_email_tds_option) ? $admin_from_email_tds_option : '';

            $admin_from_name_tds_option = tds_util::get_tds_option('from_name');
            $from_name = !is_null( $admin_from_name_tds_option ) && !is_null($admin_activate_email_tds_option) ? $admin_from_name_tds_option : '';
