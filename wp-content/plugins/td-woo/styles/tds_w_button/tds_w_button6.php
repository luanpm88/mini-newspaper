    ...
    private function get_css() {
		...
		$raw_css =
			"<style>
				...
				body.woocommerce div.tds-w-button6 form.cart .single_add_to_cart_button {
                    color: #000;
				...
				body.woocommerce div.tds-w-button6 form.cart .single_add_to_cart_button:before {
                    content: '';
                    background-color: #fff;
                    padding-top: 100%;
                    width: 100%;
				...
				body.woocommerce div.$unique_block_class .tdw-block-inner form.cart button.single_add_to_cart_button {
				...
				body.woocommerce div.$unique_block_class .tdw-block-inner form.cart button.single_add_to_cart_button:before {
				...
				body.woocommerce div.$unique_block_class .tdw-block-inner form.cart button.single_add_to_cart_button:hover:before {
