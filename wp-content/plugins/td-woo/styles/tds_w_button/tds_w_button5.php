    ...
    private function get_css() {
		...
		$raw_css =
			"<style>
				...
				body.woocommerce div.tds-w-button5 form.cart .single_add_to_cart_button {
                    position: relative;
                    color: #222;
                    border-color: #222;
                    -webkit-transition: all 0.3s;
				...
				body.woocommerce div.tds-w-button5 form.cart .single_add_to_cart_button:hover {
				...
				body.woocommerce div.tds-w-button5 form.cart .single_add_to_cart_button:before {
                    content: '';
                    position: absolute;
                    width: 100%;
                    height: 100%;
				...
				body.woocommerce div.tds-w-button5 form.cart .single_add_to_cart_button:hover:before {
                    top: 0;
                    left: 0;
