    ...
    private function get_css() {
		...
		$raw_css =
			"<style>
				...
				body.woocommerce div.tds-w-button3 form.cart .single_add_to_cart_button {
				...
				body.woocommerce div.tds-w-button3 form.cart .single_add_to_cart_button,
				body.woocommerce div.tds-w-button3 form.cart .single_add_to_cart_button:hover {
				    color: #000;
				}
				...
				body.woocommerce div.tds-w-button3 form.cart .single_add_to_cart_button:before {
                    content: '';
                    width: 100%;
                    height: 100%;
				    background-color: #fff;
				...
				body.woocommerce div.tds-w-button3 form.cart .single_add_to_cart_button:hover:before {
                    opacity: 1;
                }
				...
				body.woocommerce div.$unique_block_class form.cart button.single_add_to_cart_button {
				...
				body.woocommerce div.$unique_block_class form.cart button.single_add_to_cart_button:before {
				...
				body.woocommerce div.$unique_block_class form.cart button.single_add_to_cart_button:hover:before {
					opacity: 1;
				}
				...
				body.woocommerce div.$unique_block_class form.cart button.single_add_to_cart_button:hover {
				...
				body.woocommerce div.$unique_block_class form.cart .single_add_to_cart_button {
					box-shadow: @shadow;
				}
				/* @shadow_hover */
				...
				body.woocommerce div.$unique_block_class form.cart .single_add_to_cart_button:hover {
