                            ...
                            $logged_in_data .= '<div class="tdw-wml-menu-inner">';
                                ...
                                $logged_in_data .= '<div class="tdw-wml-menu-content">';
                                    $logged_in_data .= '<ul class="tdw-wml-menu-list">';
                                        ...
                                        $logged_in_data .= '<li><a class="' . wc_get_account_menu_item_classes( 'donwloads' ) . '" href="' . wc_get_account_endpoint_url( get_option( 'woocommerce_myaccount_downloads_endpoint', 'downloads' ) ) . '">' . __td('Downloads', TD_THEME_NAME) . '</a></li>';
