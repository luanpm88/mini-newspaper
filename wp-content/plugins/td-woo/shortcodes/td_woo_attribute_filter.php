...
class td_woo_attribute_filter extends td_block {
	...
	public function get_custom_css() {
		...
		$raw_css = "
			<style>
                ...
                /* @all_color_border */
                body.woocommerce div.$unique_block_class .color-list-wrapper .color-tdw-filter-item {
                    box-shadow: inset 0 0 0 @all_color_border @all_color_border_c;
                }
                /* @all_color_border_s */
                body.woocommerce div.$unique_block_class .color-list-wrapper .color-tdw-filter-item:hover,
                body.woocommerce div.$unique_block_class .color-list-wrapper .color-tdw-filter-item.selected {
                ...
                /* @but_txt */
                body .$unique_block_class .button-tdw-filter-item .tdw-filter-item-span-button {
                    color: @but_txt;
                }
                /* @but_txt_s */
                ...
                /* @but_bg */
                body.woocommerce div.$unique_block_class .button-list-wrapper .button-tdw-filter-item {
                    background-color: @but_bg;
                }
                /* @but_bg_s */
                body.woocommerce div.$unique_block_class .button-list-wrapper .button-tdw-filter-item:hover,
                body.woocommerce div.$unique_block_class .button-list-wrapper .button-tdw-filter-item.selected {
                            ...
                            switch ( $type ) {
                                case 'image':
                                    ...
                                    if ( $term->taxonomy === 'product_cat') {
                                        $term_meta_img_attachment_id = get_term_meta( $term->term_id, 'thumbnail_id', true );
                                    }
                                    $image = array();
	...
	function inner( $shortcode_atts, $td_woo_state_has_wp_query ) {
        ...
        td_resources_load::render_script( TD_WOO_SCRIPTS_URL . '/tdwFiltersList.js' . TD_WOO_SCRIPTS_VER, 'tdwFiltersList-js', '', 'footer' );
        td_resources_load::render_script( TD_WOO_SCRIPTS_URL . '/tdwFilter.js' . TD_WOO_SCRIPTS_VER, 'tdwFilter-js', '', 'footer' );
		ob_start();
		?>
		<script>
	...
	function js_tdc_callback_ajax() {
        ...
        <script>
            ...
            (function () {
                ...
                var tdThemeWrapEl = jQuery("#td-outer-wrap");
