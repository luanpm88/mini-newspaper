...
class td_woo_product_module extends td_module {
        ...
        <div class="<?php echo $this->get_module_classes();?>">
            <div class="td-module-container">
                    ...
                    <div class="td-image-container">
                        ...
                        if( isset( $this->module_atts['show_favourites'] ) ) {
                            if ( !empty( $this->get_shortcode_att('show_favourites') ) ) {
                                echo $this->tdw_get_favorite_badge( $this->product->get_id() );
                            }
                        }
                        ?>
                    </div>
                ...
                <div class="td-module-meta-info">
                    <<?php echo $product_title_tag ?> class="td-module-title"><a href="<?php echo esc_url( $link ) ?>" <?php echo $target_blank ?> class="product-link"><?php echo $this->product->get_title() ?></a></<?php echo $product_title_tag ?>>
    ...
    function tdw_get_favorite_badge( $prod_id ) {
